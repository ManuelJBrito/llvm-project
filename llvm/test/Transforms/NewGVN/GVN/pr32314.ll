...
; NewGVN adds a phi-of-ops for the loop induction variable offset.

target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; The load in the loop can not bypass the data from the previous loop.
define void @foo() {
; CHECK-LABEL: @foo(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    ret void
; CHECK:       for.body:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i64 [ 0, [[ENTRY:%.*]] ], [ [[INDVARS_IV:%.*]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[INDVARS_IV]] = phi i64 [ 1, [[ENTRY]] ], [ [[INDVARS_IV_NEXT:%.*]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[P_017:%.*]] = phi ptr [ undef, [[ENTRY]] ], [ [[ARRAYIDX3:%.*]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [3 x i32], ptr [[A]], i64 0, i64 [[PHIOFOPS]]
; CHECK-NEXT:    store i32 50, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[TMP0:%.*]] = shl i64 [[INDVARS_IV]], 1
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[P_017]], align 4
