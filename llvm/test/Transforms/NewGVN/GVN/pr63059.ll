...
; CHECK-NEXT:    [[INS1:%.*]] = insertelement <4 x float> [[SHUF]], float [[LOAD1]], i64 1
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr inbounds [4 x float], ptr [[LOC]], i64 0, i64 2
; CHECK-NEXT:    [[LOAD2:%.*]] = load float, ptr [[GEP2]], align 8
; CHECK-NEXT:    [[INS2:%.*]] = insertelement <4 x float> [[INS1]], float [[LOAD2]], i64 2
; CHECK-NEXT:    [[INS3:%.*]] = insertelement <4 x float> [[INS2]], float [[LOAD2]], i64 3
...
; CHECK-NEXT:    [[REF:%.*]] = load double, ptr [[GEP]], align 8
; CHECK-NEXT:    ret double [[REF]]
;
