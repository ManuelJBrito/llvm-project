...
; NewGVN partially propagates knowledge from @llvm.assume calls:
; it replaces direct uses of assumed-true values (assume_arg) but does
; not propagate negations (assume_not_arg, pr47496) or convert
; assume(false) to unreachable like GVN does.
