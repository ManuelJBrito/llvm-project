...
; CHECK-NEXT:    [[TMP56119:%.*]] = getelementptr [[STRUCT_TYPHEADER:%.*]], ptr [[HDR]], i32 0, i32 0
; CHECK-NEXT:    [[TMP56220:%.*]] = load i32, ptr [[TMP56119]], align 4
; CHECK-NEXT:    br i1 false, label %[[BB_NPH23:.*]], label %[[BB675_PREHEADER:.*]]
; CHECK:       [[BB_NPH23]]:
; CHECK-NEXT:    ret ptr null
; CHECK:       [[BB656:.*]]:
; CHECK-NEXT:    [[TMP678:%.*]] = load i32, ptr [[TMP677:%.*]], align 4
; CHECK-NEXT:    br i1 false, label %[[BB684:.*]], label %[[BB656]]
; CHECK:       [[BB684]]:
; CHECK-NEXT:    br i1 false, label %[[BB924_PREHEADER:.*]], label %[[BB675_OUTER:.*]]
; CHECK:       [[BB675_OUTER]]:
; CHECK-NEXT:    [[TMP67812:%.*]] = load i32, ptr [[TMP67711:%.*]], align 4
; CHECK-NEXT:    br i1 false, label %[[BB684]], label %[[BB656]]
; CHECK:       [[BB675_PREHEADER]]:
; CHECK-NEXT:    [[TMP67711]] = getelementptr [[STRUCT_TYPHEADER]], ptr [[HDR]], i32 0, i32 0
; CHECK-NEXT:    [[TMP677]] = getelementptr [[STRUCT_TYPHEADER]], ptr [[HDR]], i32 0, i32 0
