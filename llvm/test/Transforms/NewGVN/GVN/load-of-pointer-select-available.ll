...
; CHECK-LABEL: define i32 @load_of_ptr_select_can_be_replaced_by_value_select(
...
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[L_2:%.*]] = phi i32 [ [[L_2_PRE]], %[[ENTRY]] ], [ [[MIN_VAL:%.*]], %[[LOOP_LOOP_CRIT_EDGE:.*]] ]
...
; CHECK-LABEL: define i32 @different_phis_1(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-NEXT:    [[L_2:%.*]] = phi i32 [ [[L_2_PRE]], %[[ENTRY]] ], [ [[MIN_VAL:%.*]], %[[LOOP_LOOP_CRIT_EDGE:.*]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[START_PTR]], %[[ENTRY]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[MIN_PTR:%.*]] = phi ptr [ null, %[[ENTRY]] ], [ [[MIN_SELECT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[L_1:%.*]] = load i32, ptr [[PTR_IV]], align 4
; CHECK-NEXT:    [[CMP_1:%.*]] = icmp ult i32 [[L_1]], [[L_2]]
; CHECK-NEXT:    [[MIN_VAL]] = select i1 [[CMP_1]], i32 [[L_1]], i32 [[L_2]]
; CHECK-NEXT:    [[MIN_SELECT]] = select i1 [[CMP_1]], ptr [[PTR_IV]], ptr [[MIN_PTR]]
...
; CHECK-LABEL: define i32 @different_phi_2(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-NEXT:    [[L_2:%.*]] = phi i32 [ [[L_2_PRE]], %[[ENTRY]] ], [ [[MIN_VAL:%.*]], %[[LOOP_LOOP_CRIT_EDGE:.*]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[START_PTR]], %[[ENTRY]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[MIN_PTR:%.*]] = phi ptr [ [[PTR]], %[[ENTRY]] ], [ [[START_PTR]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[L_1:%.*]] = load i32, ptr [[PTR_IV]], align 4
; CHECK-NEXT:    [[CMP_1:%.*]] = icmp ult i32 [[L_1]], [[L_2]]
; CHECK-NEXT:    [[MIN_VAL]] = select i1 [[CMP_1]], i32 [[L_1]], i32 [[L_2]]
; CHECK-NEXT:    [[MIN_SELECT:%.*]] = select i1 [[CMP_1]], ptr [[PTR_IV]], ptr [[MIN_PTR]]
...
; CHECK-LABEL: define i32 @different_phis_3(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[L_2:%.*]] = phi i32 [ 19, %[[ENTRY]] ], [ [[MIN_VAL:%.*]], %[[LOOP_LOOP_CRIT_EDGE:.*]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[START_PTR]], %[[ENTRY]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[MIN_PTR:%.*]] = phi ptr [ [[PTR]], %[[ENTRY]] ], [ [[MIN_SELECT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[L_1:%.*]] = load i32, ptr [[PTR_IV]], align 4
; CHECK-NEXT:    [[CMP_1:%.*]] = icmp ult i32 [[L_1]], [[L_2]]
...
; CHECK-LABEL: define i32 @different_phis_4(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[L_2:%.*]] = phi i32 [ [[L_2_PRE]], %[[ENTRY]] ], [ 10, %[[LOOP_LOOP_CRIT_EDGE:.*]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[START_PTR]], %[[ENTRY]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[MIN_PTR:%.*]] = phi ptr [ [[PTR]], %[[ENTRY]] ], [ [[MIN_SELECT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[L_1:%.*]] = load i32, ptr [[PTR_IV]], align 4
; CHECK-NEXT:    [[CMP_1:%.*]] = icmp ult i32 [[L_1]], [[L_2]]
...
; CHECK-LABEL: define i32 @load_before_loop_in_different_block(
...
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[L_2:%.*]] = phi i32 [ [[L_2_PRE]], %[[PH]] ], [ [[MIN_VAL:%.*]], %[[LOOP_LOOP_CRIT_EDGE:.*]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[START_PTR]], %[[PH]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[MIN_PTR:%.*]] = phi ptr [ [[PTR]], %[[PH]] ], [ [[MIN_SELECT:%.*]], %[[LOOP_LOOP_CRIT_EDGE]] ]
; CHECK-NEXT:    [[L_1:%.*]] = load i32, ptr [[PTR_IV]], align 4
; CHECK-NEXT:    [[CMP_1:%.*]] = icmp ult i32 [[L_1]], [[L_2]]
; CHECK-NEXT:    [[MIN_VAL]] = select i1 [[CMP_1]], i32 [[L_1]], i32 [[L_2]]
; CHECK-NEXT:    [[MIN_SELECT]] = select i1 [[CMP_1]], ptr [[PTR_IV]], ptr [[MIN_PTR]]
...
; CHECK-LABEL: define i32 @selects_use_different_compares(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @value_select_different_value_1(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @value_select_different_value_2(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]], ptr [[PTR_2:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_1(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_in_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_in_loop_2(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_in_loop_3(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_in_loop_4(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]], ptr [[PTR_2:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_by_call_before_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]], ptr [[PTR_2:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_by_call_in_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]], ptr [[PTR_2:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_by_call_after_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]], ptr [[PTR_2:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_clobbered_after_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_may_throw_before_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_may_throw_in_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
...
; CHECK-LABEL: define i32 @pointer_select_may_throw_after_loop(
; CHECK-SAME: ptr [[PTR:%.*]], ptr [[END:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[START_PTR:%.*]] = getelementptr inbounds i32, ptr [[PTR]], i64 1
; CHECK-NEXT:    [[L_2_PRE:%.*]] = load i32, ptr [[PTR]], align 4
