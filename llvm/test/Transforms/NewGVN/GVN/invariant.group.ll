...
; CHECK-NEXT:    [[D:%.*]] = load i8, ptr [[NEWPTR2]], align 1, !invariant.group [[META0]]
; CHECK-NEXT:    ret i8 [[D]]
;
entry:
  %ptr = alloca i8
...
; CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @_ZTV1A, i64 0, i64 2), align 8
; CHECK-NEXT:    call void [[TMP8]](ptr nonnull [[A]])
