...
; CHECK:       [[BB13]]:
; CHECK-NEXT:    br i1 undef, label %[[BB13_BB30THREAD_PRE_SPLIT_CRIT_EDGE:.*]], label %[[BB16:.*]]
; CHECK:       [[BB13_BB30THREAD_PRE_SPLIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB30THREAD_PRE_SPLIT:.*]]
; CHECK:       [[BB16]]:
; CHECK-NEXT:    [[I17:%.*]] = tail call ptr @j()
; CHECK-NEXT:    br i1 undef, label %[[BB22THREAD_PRE_SPLIT:.*]], label %[[BB16_BB37_LOOPEXIT_CRIT_EDGE:.*]]
; CHECK:       [[BB16_BB37_LOOPEXIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB37_LOOPEXIT:.*]]
; CHECK:       [[BB22THREAD_PRE_SPLIT]]:
; CHECK-NEXT:    br i1 undef, label %[[BB22THREAD_PRE_SPLIT_BB30THREAD_PRE_SPLIT_CRIT_EDGE:.*]], label %[[BB22THREAD_PRE_SPLIT_BB37_LOOPEXIT_CRIT_EDGE:.*]]
; CHECK:       [[BB22THREAD_PRE_SPLIT_BB37_LOOPEXIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB37_LOOPEXIT]]
; CHECK:       [[BB22THREAD_PRE_SPLIT_BB30THREAD_PRE_SPLIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB30THREAD_PRE_SPLIT]]
; CHECK:       [[BB30THREAD_PRE_SPLIT]]:
; CHECK-NEXT:    br i1 undef, label %[[BB30THREAD_PRE_SPLIT_BB37_LOOPEXIT_CRIT_EDGE:.*]], label %[[BB30THREAD_PRE_SPLIT_BB13_CRIT_EDGE:.*]]
; CHECK:       [[BB30THREAD_PRE_SPLIT_BB13_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB13]]
; CHECK:       [[BB30THREAD_PRE_SPLIT_BB37_LOOPEXIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB37_LOOPEXIT]]
; CHECK:       [[BB37_LOOPEXIT]]:
; CHECK-NEXT:    [[I38_PRE:%.*]] = load i32, ptr @a, align 4
; CHECK-NEXT:    br label %[[BB37]]
; CHECK:       [[BB37]]:
; CHECK-NEXT:    [[I38:%.*]] = phi i32 [ [[I4]], %[[BB3]] ], [ [[I38_PRE]], %[[BB37_LOOPEXIT]] ]
