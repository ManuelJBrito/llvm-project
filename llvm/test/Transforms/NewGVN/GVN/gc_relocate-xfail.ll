...
; CHECK-LABEL: define i1 @test_trivial(
; CHECK-SAME: ptr addrspace(1) [[IN:%.*]]) gc "statepoint-example" {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i1 @test_readnone(
; CHECK-SAME: ptr addrspace(1) [[IN:%.*]]) gc "statepoint-example" {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[SAFEPOINT_TOKEN:%.*]] = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 0, i32 0, ptr elementtype(void ()) @func, i32 0, i32 0, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) [[IN]]) ]
; CHECK-NEXT:    [[A:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[SAFEPOINT_TOKEN]], i32 0, i32 0)
...
; CHECK-LABEL: define i1 @test_call(
; CHECK-SAME: ptr addrspace(1) [[IN:%.*]]) gc "statepoint-example" {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i1 @test_two_calls(
; CHECK-SAME: ptr addrspace(1) [[IN1:%.*]], ptr addrspace(1) [[IN2:%.*]]) gc "statepoint-example" {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define ptr addrspace(1) @test_invoke(
; CHECK-SAME: ptr addrspace(1) [[IN:%.*]]) gc "statepoint-example" personality ptr @personality_function {
...
;
; CHECK-LABEL: define i1 @test_non_dominating(
; CHECK-SAME: i1 [[C:%.*]], ptr addrspace(1) [[IN:%.*]]) gc "statepoint-example" {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[SAFEPOINT_TOKEN:%.*]] = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 0, i32 0, ptr elementtype(void ()) @func, i32 0, i32 0, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) [[IN]]) ]
