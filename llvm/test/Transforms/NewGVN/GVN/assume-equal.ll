...
; CHECK:       [[IF_THEN]]:
; CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr getelementptr inbounds ([4 x ptr], ptr @_ZTV1A, i64 0, i64 2), align 8
; CHECK-NEXT:    [[CALL2:%.*]] = tail call i32 [[TMP0]](ptr [[CALL]])
; CHECK-NEXT:    br label %[[IF_END:.*]]
; CHECK:       [[IF_ELSE]]:
; CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZTV1A, i64 24), align 8
; CHECK-NEXT:    [[CALL5:%.*]] = tail call i32 [[TMP1]](ptr [[CALL]])
; CHECK-NEXT:    br label %[[IF_END]]
; CHECK:       [[IF_END]]:
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr getelementptr inbounds ([4 x ptr], ptr @_ZTV1A, i64 0, i64 2), align 8
; CHECK-NEXT:    [[CALL2:%.*]] = tail call i32 [[TMP0]](ptr [[CALL]])
; CHECK-NEXT:    [[CALL1:%.*]] = load ptr, ptr [[VTABLE]], align 8
; CHECK-NEXT:    [[CALLX:%.*]] = tail call i32 [[CALL1]](ptr [[CALL]])
; CHECK-NEXT:    [[CALL4:%.*]] = load ptr, ptr [[VTABLE]], align 8
; CHECK-NEXT:    [[CALLY:%.*]] = tail call i32 [[CALL4]](ptr [[CALL]])
; CHECK-NEXT:    [[VFUN:%.*]] = load ptr, ptr [[VTABLE]], align 8
; CHECK-NEXT:    [[UNKNOWN:%.*]] = tail call i32 [[VFUN]](ptr [[CALL]])
; CHECK-NEXT:    br label %[[IF_END:.*]]
; CHECK:       [[IF_ELSE]]:
; CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZTV1A, i64 24), align 8
; CHECK-NEXT:    [[CALL5:%.*]] = tail call i32 [[TMP1]](ptr [[CALL]])
...
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[P]], 42
; CHECK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; CHECK-NEXT:    br i1 true, label %[[BB0:.*]], label %[[BB0]]
; CHECK:       [[BB0]]:
