...
; NewGVN eliminates unused instructions (implicit DCE) while GVN
; preserves them. Both correctly avoid forwarding between scalable
; vector and scalar loads at the same address.
