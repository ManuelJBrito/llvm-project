...
; CHECK-NEXT:    br label %[[BB13]]
; CHECK:       [[BB13]]:
; CHECK-NEXT:    [[TMP5]] = phi i32 [ [[TMP12]], %[[BB4]] ], [ 0, %[[BB]] ]
...
; CHECK-NEXT:    br label %[[BB49]]
; CHECK:       [[BB49]]:
; CHECK-NEXT:    [[TMP19]] = phi i32 [ [[TMP48]], %[[BB18]] ], [ 0, %[[BB17]] ]
; CHECK-NEXT:    [[TMP50:%.*]] = load i32, ptr @numi, align 4
; CHECK-NEXT:    [[TMP52:%.*]] = icmp slt i32 [[TMP19]], [[TMP50]]
...
; CHECK-NEXT:    [[TMP67]] = phi i32 [ [[TMP78]], %[[BB66]] ], [ 0, %[[COND_TRUE]] ]
; CHECK-NEXT:    [[TMP80:%.*]] = load i32, ptr @numi, align 4
; CHECK-NEXT:    [[TMP82:%.*]] = icmp slt i32 [[TMP67]], [[TMP80]]
