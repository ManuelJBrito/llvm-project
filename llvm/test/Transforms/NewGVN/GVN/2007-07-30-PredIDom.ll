...
; CHECK-LABEL: define ptr @_ZN3Exp8toStringEj(
; CHECK-SAME: ptr [[THIS:%.*]], i32 [[NEXTPC:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    switch i32 0, label %[[BB970:.*]] [
; CHECK-NEXT:      i32 1, label %[[BB:.*]]
; CHECK-NEXT:      i32 2, label %[[BB39:.*]]
; CHECK-NEXT:      i32 3, label %[[BB195:.*]]
; CHECK-NEXT:      i32 4, label %[[BB270:.*]]
; CHECK-NEXT:      i32 5, label %[[BB418:.*]]
; CHECK-NEXT:      i32 6, label %[[BB633:.*]]
; CHECK-NEXT:      i32 7, label %[[BB810:.*]]
; CHECK-NEXT:      i32 8, label %[[BB882:.*]]
; CHECK-NEXT:      i32 9, label %[[BB925:.*]]
; CHECK-NEXT:    ]
; CHECK:       [[BB]]:
...
; CHECK:       [[BB39]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE:.*]], label %[[COND_FALSE132:.*]]
; CHECK:       [[COND_TRUE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
...
; CHECK:       [[COND_NEXT]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT131:.*]]
; CHECK:       [[COND_FALSE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT131]]
; CHECK:       [[COND_NEXT131]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT141:.*]]
; CHECK:       [[COND_FALSE132]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT141]]
; CHECK:       [[COND_NEXT141]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE169:.*]], label %[[COND_FALSE175:.*]]
; CHECK:       [[COND_TRUE169]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
...
; CHECK:       [[BB195]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE248:.*]], label %[[COND_FALSE250:.*]]
; CHECK:       [[COND_TRUE248]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
...
; CHECK:       [[BB270]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE338:.*]], label %[[COND_FALSE340:.*]]
; CHECK:       [[COND_TRUE338]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT342:.*]]
; CHECK:       [[COND_FALSE340]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT342]]
; CHECK:       [[COND_NEXT342]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE362:.*]], label %[[COND_FALSE364:.*]]
; CHECK:       [[COND_TRUE362]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
...
; CHECK:       [[BB418]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE512:.*]], label %[[COND_FALSE514:.*]]
; CHECK:       [[COND_TRUE512]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT516:.*]]
; CHECK:       [[COND_FALSE514]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT516]]
; CHECK:       [[COND_NEXT516]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE536:.*]], label %[[COND_FALSE538:.*]]
; CHECK:       [[COND_TRUE536]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT540:.*]]
; CHECK:       [[COND_FALSE538]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[COND_NEXT540]]
; CHECK:       [[COND_NEXT540]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[COND_TRUE560:.*]], label %[[COND_FALSE562:.*]]
; CHECK:       [[COND_TRUE560]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
