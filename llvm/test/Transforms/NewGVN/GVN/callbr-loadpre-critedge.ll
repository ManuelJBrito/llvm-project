...
; CHECK-NEXT:            to label %[[BB4:.*]] [label %[[BB_BB5_CRIT_EDGE:.*]], label %bb.bb8_crit_edge]
; CHECK:       [[BB_BB8_CRIT_EDGE:.*]]:
; CHECK-NEXT:    [[TMP10_PRE:%.*]] = load ptr, ptr [[TMP1]], align 8
; CHECK-NEXT:    br label %[[BB8:.*]]
; CHECK:       [[BB_BB5_CRIT_EDGE]]:
...
; CHECK-NEXT:    br label %[[BB8]]
; CHECK:       [[BB8]]:
; CHECK-NEXT:    [[TMP10:%.*]] = phi ptr [ [[TMP10_PRE]], %[[BB_BB8_CRIT_EDGE]] ], [ [[TMP6]], %[[BB5]] ]
