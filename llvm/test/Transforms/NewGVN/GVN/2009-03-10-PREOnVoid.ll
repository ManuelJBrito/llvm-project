...
; CHECK-LABEL: define fastcc void @_ZNSt8_Rb_treeIPvSt4pairIKS0_S0_ESt10_Select1stIS3_ESt4lessIS0_ESaIS3_EE16_M_insert_uniqueERKS3_(
; CHECK-SAME: ptr noalias sret(%"struct.std::pair<std::_Rb_tree_iterator<std::pair<ptr const, std::vector<ShadowInfo, std::allocator<ShadowInfo> > > >,bool>") captures(none) [[AGG_RESULT:%.*]], ptr [[THIS:%.*]], ptr [[__V:%.*]]) #[[ATTR1:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 false, label %[[ENTRY_BB7_CRIT_EDGE:.*]], label %[[ENTRY_BB_CRIT_EDGE:.*]]
; CHECK:       [[ENTRY_BB_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB:.*]]
; CHECK:       [[ENTRY_BB7_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB7:.*]]
; CHECK:       [[BB]]:
; CHECK-NEXT:    br i1 false, label %[[BB5:.*]], label %[[BB_BB_CRIT_EDGE:.*]]
; CHECK:       [[BB_BB_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB]]
; CHECK:       [[BB5]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[BB5_BB11_CRIT_EDGE:.*]], label %[[BB5_BB7_CRIT_EDGE:.*]]
; CHECK:       [[BB5_BB7_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB7]]
; CHECK:       [[BB5_BB11_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
...
; CHECK-LABEL: define i32 @pthread_once(
...
; CHECK-LABEL: define ptr @pthread_getspecific(
; CHECK-SAME: i32 [[TMP0:%.*]]) {
...
; CHECK-LABEL: define i32 @pthread_setspecific(
...
; CHECK-LABEL: define i32 @pthread_create(
; CHECK-SAME: ptr [[TMP0:%.*]], ptr [[TMP1:%.*]], ptr [[TMP2:%.*]], ptr [[TMP3:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
}
...
; CHECK-LABEL: define i32 @pthread_cancel(
; CHECK-SAME: i32 [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_mutex_lock(
; CHECK-SAME: ptr [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_mutex_trylock(
; CHECK-SAME: ptr [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_mutex_unlock(
; CHECK-SAME: ptr [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_mutex_init(
; CHECK-SAME: ptr [[TMP0:%.*]], ptr [[TMP1:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_key_create(
; CHECK-SAME: ptr [[TMP0:%.*]], ptr [[TMP1:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_key_delete(
; CHECK-SAME: i32 [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_mutexattr_init(
; CHECK-SAME: ptr [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
...
; CHECK-LABEL: define i32 @pthread_mutexattr_settype(
...
; CHECK-LABEL: define i32 @pthread_mutexattr_destroy(
; CHECK-SAME: ptr [[TMP0:%.*]]) {
; CHECK-NEXT:    ret i32 0
;
  ret i32 0
