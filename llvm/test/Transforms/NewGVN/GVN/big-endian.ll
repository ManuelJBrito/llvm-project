...
; NewGVN does not do cross-type load forwarding (store i8, load i1) and
; does not optimize away the GEP to field 0 (unlike GVN which simplifies
; these on big-endian targets).
