...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[ARG]], label %[[IF_END13:.*]], label %[[ENTRY_WHILE_BODY_PREHEADER_CRIT_EDGE:.*]]
; CHECK:       [[ENTRY_WHILE_BODY_PREHEADER_CRIT_EDGE]]:
...
; CHECK:       [[LOR_LHS_FALSE]]:
; CHECK-NEXT:    br i1 [[ARG]], label %[[LAND_LHS_TRUE24:.*]], label %[[LOR_LHS_FALSE_IF_END31_CRIT_EDGE:.*]]
; CHECK:       [[LOR_LHS_FALSE_IF_END31_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[IF_END31:.*]]
; CHECK:       [[LAND_LHS_TRUE24]]:
; CHECK-NEXT:    [[CALL28:%.*]] = call ptr @parse_object(ptr undef) #[[ATTR1:[0-9]+]]
; CHECK-NEXT:    br i1 true, label %[[LAND_LHS_TRUE24_RETURN_LOOPEXIT_CRIT_EDGE:.*]], label %[[LAND_LHS_TRUE24_IF_END31_CRIT_EDGE:.*]]
; CHECK:       [[LAND_LHS_TRUE24_IF_END31_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[IF_END31]]
; CHECK:       [[LAND_LHS_TRUE24_RETURN_LOOPEXIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[RETURN_LOOPEXIT]]
; CHECK:       [[IF_END31]]:
; CHECK-NEXT:    br i1 [[ARG]], label %[[IF_END31_RETURN_LOOPEXIT_CRIT_EDGE:.*]], label %[[IF_END41:.*]]
; CHECK:       [[IF_END31_RETURN_LOOPEXIT_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[RETURN_LOOPEXIT]]
; CHECK:       [[IF_END41]]:
...
; CHECK-NEXT:    br label %[[DO_BODY57_I]]
; CHECK:       [[DO_BODY57_I]]:
; CHECK-NEXT:    [[PHIOFOPS1:%.*]] = phi i64 [ poison, %[[DO_BODY36_I_DO_BODY57_I_CRIT_EDGE]] ], [ [[IVAR59_I_PRE]], %[[IF_THEN48_I]] ]
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i64 [ poison, %[[DO_BODY36_I_DO_BODY57_I_CRIT_EDGE]] ], [ [[DOTPRE]], %[[IF_THEN48_I]] ]
; CHECK-NEXT:    ret ptr undef
;
do.end17.i:
...
; CHECK:       [[U1_BB:.*]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 [[ARG]], label %[[U1_BB_U2_BB_CRIT_EDGE:.*]], label %[[U1_BB]]
; CHECK:       [[U1_BB_U2_BB_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[U2_BB]]
; CHECK:       [[U2_BB]]:
; CHECK-NEXT:    br label %[[U2_BB]]
