...
; NewGVN (like GVN<memoryssa>) does not forward the load through the
; inttoptr/store because the store changes the memory interpretation.
...
; CHECK-NEXT:    [[V5:%.*]] = load <2 x i32>, ptr [[V1]], align 8
; CHECK-NEXT:    ret <2 x i32> [[V5]]
;
  %v1 = alloca <2 x i32>
