...
; NewGVN more aggressively eliminates unused masked loads and dead
; code before unreachable (unlike GVN which keeps the first masked load).
...
; CHECK-LABEL: @test(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[DOTPRE392_I:%.*]] = load i64, ptr getelementptr inbounds ([8 x i64], ptr @file_mask, i64 0, i64 7), align 8
