...
; CHECK-NEXT:    br label [[BB8]]
; CHECK:       bb3:
; CHECK-NEXT:    br i1 [[TMP1]], label [[BB4:%.*]], label [[BB5:%.*]]
; CHECK:       bb4:
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[TMP0]], 5
; CHECK-NEXT:    br label [[BB8]]
; CHECK:       bb5:
; CHECK-NEXT:    br i1 [[TMP2]], label [[BB6:%.*]], label [[BB7:%.*]]
; CHECK:       bb6:
...
; CHECK:       bb4:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i1 [ true, [[ENTRY:%.*]] ], [ [[CMP1]], [[BB3]] ]
; CHECK-NEXT:    [[PHI1:%.*]] = phi ptr [ [[P1]], [[ENTRY]] ], [ [[P2]], [[BB3]] ]
; CHECK-NEXT:    call void @use_bool(i1 [[PHIOFOPS]])
; CHECK-NEXT:    call void @use_ptr(ptr [[PHI1]])
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    br label [[BB4]]
; CHECK:       bb4:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i1 [ true, [[ENTRY:%.*]] ], [ [[CMP1]], [[BB3]] ], [ [[CMP1]], [[BB2]] ]
; CHECK-NEXT:    [[PHI1:%.*]] = phi ptr [ [[P1]], [[ENTRY]] ], [ [[P2]], [[BB2]] ], [ [[P2]], [[BB3]] ]
; CHECK-NEXT:    call void @use_bool(i1 [[PHIOFOPS]])
; CHECK-NEXT:    call void @use_ptr(ptr [[PHI1]])
; CHECK-NEXT:    ret void
;
...
; CHECK:       bb5:
; CHECK-NEXT:    call void @use_ptr(ptr [[P1]])
; CHECK-NEXT:    br label [[BB5]]
;
entry:
  %p2 = load ptr, ptr %p0, align 8
...
; CHECK-NEXT:    br label [[BB4]]
; CHECK:       bb4:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i1 [ true, [[ENTRY:%.*]] ], [ poison, [[BB3]] ], [ [[CMP1]], [[BB2]] ]
; CHECK-NEXT:    [[PHI1:%.*]] = phi ptr [ [[P1]], [[ENTRY]] ], [ [[P2]], [[BB2]] ], [ poison, [[BB3]] ]
; CHECK-NEXT:    call void @use_bool(i1 [[PHIOFOPS]])
; CHECK-NEXT:    br label [[BB5:%.*]]
; CHECK:       bb5:
; CHECK-NEXT:    call void @use_ptr(ptr [[PHI1]])
