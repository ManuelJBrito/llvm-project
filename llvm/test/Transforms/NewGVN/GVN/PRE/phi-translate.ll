...
; CHECK-NEXT:    [[Q:%.*]] = getelementptr [100 x i32], ptr @G, i64 0, i64 [[PRE_PHI]], !dbg [[DBG11:![0-9]+]]
; CHECK-NEXT:    [[N:%.*]] = load i32, ptr [[Q]], align 4, !dbg [[DBG12:![0-9]+]]
; CHECK-NEXT:    ret i32 [[N]], !dbg [[DBG12]]
;
entry:
...
; CHECK: [[DBG11]] = !DILocation(line: 46, column: 1, scope: [[DBG5]])
; CHECK: [[DBG12]] = !DILocation(line: 47, column: 1, scope: [[DBG5]])
;.
