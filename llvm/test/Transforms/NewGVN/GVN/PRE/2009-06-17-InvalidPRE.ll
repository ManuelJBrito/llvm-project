...
; CHECK:       [[BB4_PREHEADER]]:
; CHECK-NEXT:    [[DOTPHI_TRANS_INSERT:%.*]] = getelementptr [[STRUCT_MBUF:%.*]], ptr [[MP]], i32 0, i32 2
; CHECK-NEXT:    [[DOTPRE_PRE:%.*]] = load i32, ptr [[DOTPHI_TRANS_INSERT]], align 4
; CHECK-NEXT:    [[DOTPHI_TRANS_INSERT4:%.*]] = getelementptr [[STRUCT_MBUF]], ptr [[MP]], i32 0, i32 3
; CHECK-NEXT:    [[DOTPRE2_PRE:%.*]] = load ptr, ptr [[DOTPHI_TRANS_INSERT4]], align 4
...
; CHECK-NEXT:    br label %[[BB4_OUTER]]
; CHECK:       [[BB4_OUTER]]:
; CHECK-NEXT:    [[DOTPRE1_PRE_PHI:%.*]] = phi ptr [ [[TMP12:%.*]], %[[BB2]] ], [ [[DOTPRE2_PRE]], %[[BB4_PREHEADER]] ]
; CHECK-NEXT:    [[DOTPRE_PRE_PHI:%.*]] = phi i32 [ 0, %[[BB2]] ], [ [[DOTPRE_PRE]], %[[BB4_PREHEADER]] ]
...
; CHECK:       [[BB4]]:
; CHECK-NEXT:    [[TMP12]] = phi ptr [ [[TMP13:%.*]], %[[BB3:.*]] ], [ [[DOTPRE1_PRE_PHI]], %[[BB4_OUTER]] ]
; CHECK-NEXT:    [[TMP9]] = phi i32 [ [[TMP11:%.*]], %[[BB3]] ], [ [[DOTPRE_PRE_PHI]], %[[BB4_OUTER]] ]
