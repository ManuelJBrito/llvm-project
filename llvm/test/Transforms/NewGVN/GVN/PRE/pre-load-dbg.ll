...
; Debug information should not impact newgvn. The following two functions have same
...
; CHECK-NEXT:    br label %[[LOR_END]]
; CHECK:       [[LOR_END]]:
; CHECK-NEXT:    [[PHIOFOPS2:%.*]] = phi i16 [ poison, %[[LOR_RHS]] ], [ [[TMP11_PRE]], %[[ENTRY_LOR_END_CRIT_EDGE]] ]
; CHECK-NEXT:    [[PHIOFOPS1:%.*]] = phi i32 [ poison, %[[LOR_RHS]] ], [ [[CONV_I_I6]], %[[ENTRY_LOR_END_CRIT_EDGE]] ]
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi ptr [ poison, %[[LOR_RHS]] ], [ [[TMP12_PRE]], %[[ENTRY_LOR_END_CRIT_EDGE]] ]
; CHECK-NEXT:    store i32 [[PHIOFOPS1]], ptr [[PHIOFOPS]], align 1
; CHECK-NEXT:    ret void
;
