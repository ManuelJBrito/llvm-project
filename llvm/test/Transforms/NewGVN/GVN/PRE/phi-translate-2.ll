...
; CHECK:       if.end:
; CHECK-NEXT:    [[MUL3_PRE_PHI:%.*]] = phi i64 [ [[MUL]], [[ENTRY:%.*]] ], [ [[MUL2]], [[IF_THEN]] ]
...
; CHECK-NEXT:    [[SUB_PTR_RHS_CAST5:%.*]] = ptrtoint ptr [[P_0]] to i64
; CHECK-NEXT:    [[SUB_PTR_SUB6_PRE_PHI:%.*]] = sub i64 [[SUB_PTR_LHS_CAST]], [[SUB_PTR_RHS_CAST5]]
