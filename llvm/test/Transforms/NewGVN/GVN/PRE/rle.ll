...
; CHECK-NEXT:    [[TTMP:%.*]] = load i8, ptr @helper, align 1
; CHECK-NEXT:    ret void
;
...
;
; CHECK-LABEL: define i8 @coerce_mustalias5(
; CHECK-SAME: i32 [[V:%.*]], ptr [[P:%.*]]) {
; CHECK-NEXT:    store i32 [[V]], ptr [[P]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = trunc i32 [[V]] to i8
...
; BE-MEMSSA-NEXT:    ret float [[A]]
;
; CHECK-LABEL: define float @coerce_mustalias6(
; CHECK-SAME: i64 [[V:%.*]], ptr [[P:%.*]]) {
; CHECK-NEXT:    store i64 [[V]], ptr [[P]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = trunc i64 [[V]] to i32
...
; BE-MEMSSA-NEXT:    ret ptr [[A]]
;
; CHECK-LABEL: define ptr @coerce_mustalias7(
; CHECK-SAME: i64 [[V:%.*]], ptr [[P:%.*]]) {
; CHECK-NEXT:    store i64 [[V]], ptr [[P]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = inttoptr i64 [[V]] to ptr
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i16, ptr [[A]], i64 42
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[A]], i64 42
; CHECK-NEXT:    [[TTMP2:%.*]] = load float, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    ret float [[TTMP2]]
;
entry:
...
; CHECK-NEXT:    br label %[[CONT]]
; CHECK:       [[CONT]]:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i16 [ 514, %[[F]] ], [ 257, %[[T]] ]
; CHECK-NEXT:    [[P2:%.*]] = getelementptr i16, ptr [[P]], i32 4
; CHECK-NEXT:    ret i16 [[PHIOFOPS]]
;
  br i1 %cond, label %T, label %F
T:
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[A]], i64 1
...
; BE-MEMSSA-NEXT:    ret i8 [[A]]
;
; CHECK-LABEL: define i8 @coerce_mustalias_nonlocal0(
; CHECK-SAME: ptr [[P:%.*]], i1 [[COND:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[T:.*]], label %[[F:.*]]
; CHECK:       [[T]]:
...
; CHECK-NEXT:    br label %[[CONT]]
; CHECK:       [[CONT]]:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i8 [ 0, %[[F]] ], [ 42, %[[T]] ]
; CHECK-NEXT:    ret i8 [[PHIOFOPS]]
;
  br i1 %cond, label %T, label %F
T:
  store i32 42, ptr %P
...
; BE-MEMSSA-NEXT:    ret i8 [[A]]
;
; CHECK-LABEL: define i8 @coerce_mustalias_nonlocal1(
; CHECK-SAME: ptr [[P:%.*]], i1 [[COND:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[T:.*]], label %[[F:.*]]
; CHECK:       [[T]]:
; CHECK-NEXT:    store i32 42, ptr [[P]], align 4
...
; BE-MEMSSA-NEXT:    ret i8 [[A]]
;
; CHECK-LABEL: define i8 @coerce_mustalias_pre0(
; CHECK-SAME: ptr [[P:%.*]], i1 [[COND:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[T:.*]], label %[[F:.*]]
; CHECK:       [[T]]:
; CHECK-NEXT:    store i32 42, ptr [[P]], align 4
...
; BE-MEMSSA-NEXT:    ret i8 [[A]]
;
; CHECK-LABEL: define i8 @coerce_offset0(
; CHECK-SAME: i32 [[V:%.*]], ptr [[P:%.*]]) {
; CHECK-NEXT:    store i32 [[V]], ptr [[P]], align 4
; CHECK-NEXT:    [[P3:%.*]] = getelementptr i8, ptr [[P]], i32 2
; CHECK-NEXT:    [[A:%.*]] = load i8, ptr [[P3]], align 1
; CHECK-NEXT:    ret i8 [[A]]
;
  store i32 %V, ptr %P
...
; BE-MEMSSA-NEXT:    ret i8 [[A]]
;
; CHECK-LABEL: define i8 @coerce_offset_nonlocal0(
; CHECK-SAME: ptr [[P:%.*]], i1 [[COND:%.*]]) {
; CHECK-NEXT:    [[P4:%.*]] = getelementptr i8, ptr [[P]], i32 2
; CHECK-NEXT:    br i1 [[COND]], label %[[T:.*]], label %[[F:.*]]
; CHECK:       [[T]]:
; CHECK-NEXT:    store i32 57005, ptr [[P]], align 4
; CHECK-NEXT:    br label %[[CONT:.*]]
; CHECK:       [[F]]:
; CHECK-NEXT:    store float 1.000000e+00, ptr [[P]], align 4
; CHECK-NEXT:    br label %[[CONT]]
; CHECK:       [[CONT]]:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i8 [ -128, %[[F]] ], [ 0, %[[T]] ]
; CHECK-NEXT:    ret i8 [[PHIOFOPS]]
;
...
; CHECK-NEXT:    br label %[[CONT]]
; CHECK:       [[CONT]]:
; CHECK-NEXT:    [[A:%.*]] = load i8, ptr [[P4]], align 1
; CHECK-NEXT:    ret i8 [[A]]
;
  %P4 = getelementptr i8, ptr %P, i32 2
  br i1 %cond, label %T, label %F
...
; CHECK-NEXT:    [[Z:%.*]] = load ptr, ptr [[P]], align 8
; CHECK-NEXT:    store ptr [[Z]], ptr [[A]], align 8
...
; CHECK-NEXT:    br label %[[BLOCK4]]
; CHECK:       [[BLOCK4]]:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i32 [ 43, %[[BLOCK3]] ], [ 0, %[[BLOCK2]] ]
; CHECK-NEXT:    [[A:%.*]] = phi i32 [ -1, %[[BLOCK2]] ], [ 42, %[[BLOCK3]] ]
; CHECK-NEXT:    br i1 [[CMPXY]], label %[[BLOCK5:.*]], label %[[EXIT:.*]]
; CHECK:       [[BLOCK5]]:
; CHECK-NEXT:    br i1 true, label %[[BLOCK6:.*]], label %[[EXIT]]
; CHECK:       [[BLOCK6]]:
; CHECK-NEXT:    [[C:%.*]] = getelementptr i32, ptr [[P]], i32 [[PHIOFOPS]]
; CHECK-NEXT:    br i1 true, label %[[BLOCK7:.*]], label %[[EXIT]]
; CHECK:       [[BLOCK7]]:
...
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[I:%.*]] = phi i32 [ 4, %[[ENTRY]] ], [ 192, %[[LOOP]] ]
...
; CHECK:       [[LATCH]]:
; CHECK-NEXT:    [[GEP_1:%.*]] = getelementptr i32, ptr [[X]], i32 [[IV]]
...
; CHECK-NEXT:    br label %[[HEADER:.*]]
; CHECK:       [[HEADER]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i32 [ 2, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LATCH:.*]] ]
...
;
; CHECK-LABEL: define i32 @load_load_partial_alias(
...
; BE-MEMSSA-NEXT:    ret i32 52
;
; CHECK-LABEL: define i32 @load_load_partial_alias_cross_block_phi_trans(
...
;
; CHECK-LABEL: define void @load_load_partial_alias_loop(
; CHECK-SAME: ptr [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; BE-MEMSSA-NEXT:    br label %[[BB5]]
;
; CHECK-LABEL: define void @load_load_partial_alias_atomic(
; CHECK-SAME: ptr [[ARG:%.*]]) {
; CHECK-NEXT:  [[BB:.*:]]
; CHECK-NEXT:    [[TMP2_1:%.*]] = getelementptr inbounds i8, ptr [[ARG]], i64 1
; CHECK-NEXT:    [[TMP2_3:%.*]] = load i64, ptr [[TMP2_1]], align 4
