...
; CHECK-NEXT:    br label %[[BLOCK4:.*]]
; CHECK:       [[BLOCK3]]:
; CHECK-NEXT:    [[B_PRE:%.*]] = sdiv i32 [[P]], [[Q]]
; CHECK-NEXT:    br label %[[BLOCK4]]
; CHECK:       [[BLOCK4]]:
; CHECK-NEXT:    [[PRE_PHI:%.*]] = phi i32 [ [[B_PRE]], %[[BLOCK3]] ], [ [[A]], %[[BLOCK2]] ]
; CHECK-NEXT:    [[PHI:%.*]] = phi i32 [ 0, %[[BLOCK3]] ], [ [[A]], %[[BLOCK2]] ]
; CHECK-NEXT:    call void @may_exit_1(i32 [[PHI]]) #[[ATTR0]]
; CHECK-NEXT:    ret i32 [[PRE_PHI]]
;
