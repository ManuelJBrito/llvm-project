...
; CHECK:       bb:
; CHECK-NEXT:    [[DOTRLE:%.*]] = phi i32 [ [[TMP0]], [[BB_NPH]] ], [ [[DOTPRE_PHI:%.*]], [[BB3_BACKEDGE:%.*]] ]
...
; CHECK:       bb3.backedge:
; CHECK-NEXT:    [[DOTPRE_PHI]] = phi i32 [ [[DOTPRE]], [[BB1]] ], [ [[TMP3]], [[BB]] ]
; CHECK-NEXT:    [[TMP6:%.*]] = icmp eq i32 [[DOTPRE_PHI]], 0
; CHECK-NEXT:    br i1 [[TMP6]], label [[RETURN]], label [[BB]]
; CHECK:       return:
; CHECK-NEXT:    ret void
;
entry:
