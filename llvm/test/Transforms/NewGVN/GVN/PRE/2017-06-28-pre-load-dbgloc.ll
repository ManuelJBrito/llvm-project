...
; CHECK-SAME: ptr readonly [[DESC:%.*]]) local_unnamed_addr !dbg [[DBG4:![0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK: [[DBG4]] = distinct !DISubprogram(name: "test", scope: [[META1]], file: [[META1]], line: 12, type: [[META5:![0-9]+]], scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: [[META0]], retainedNodes: [[META8:![0-9]+]])
