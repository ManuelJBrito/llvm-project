...
; CHECK:       [[BB159]]:
; CHECK-NEXT:    switch i32 0, label %[[BB159_BB661_CRIT_EDGE:.*]] [
; CHECK-NEXT:      i32 0, label %[[BB159_BB159_CRIT_EDGE:.*]]
; CHECK-NEXT:      i32 1, label %[[SUCCEED_LABEL]]
; CHECK-NEXT:      i32 13, label %[[BB159_BB159_CRIT_EDGE1:.*]]
; CHECK-NEXT:      i32 14, label %[[BB159_BB159_CRIT_EDGE2:.*]]
; CHECK-NEXT:      i32 16, label %[[BB159_BB411_CRIT_EDGE:.*]]
; CHECK-NEXT:      i32 24, label %[[BB159_BB622_CRIT_EDGE:.*]]
; CHECK-NEXT:      i32 28, label %[[BB543:.*]]
; CHECK-NEXT:    ]
; CHECK:       [[BB159_BB622_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB622:.*]]
; CHECK:       [[BB159_BB411_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB411:.*]]
; CHECK:       [[BB159_BB159_CRIT_EDGE2]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB159]]
; CHECK:       [[BB159_BB159_CRIT_EDGE1]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB159]]
; CHECK:       [[BB159_BB159_CRIT_EDGE]]:
; CHECK-NEXT:    br label %[[BB159]]
; CHECK:       [[BB159_BB661_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB661:.*]]
; CHECK:       [[BB411]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB411]]
; CHECK:       [[BB543]]:
...
; CHECK:       [[BB554]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[BB554_BB159_CRIT_EDGE:.*]], label %[[BB554_BB661_CRIT_EDGE:.*]]
; CHECK:       [[BB554_BB661_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB661]]
...
; CHECK:       [[BB664]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br i1 false, label %[[BB664_BB159_CRIT_EDGE:.*]], label %[[BB664_BB664_CRIT_EDGE:.*]]
; CHECK:       [[BB664_BB664_CRIT_EDGE]]:
; CHECK-NEXT:    store i8 poison, ptr null, align 1
; CHECK-NEXT:    br label %[[BB664]]
