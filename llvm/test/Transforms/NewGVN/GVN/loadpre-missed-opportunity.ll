...
; RUN: opt < %s -passes=newgvn -gvn-max-block-speculations=1 -S | FileCheck -check-prefix=PRE %s
; RUN: opt < %s -passes=newgvn -gvn-max-block-speculations=0 -S | FileCheck -check-prefix=CHECK %s
