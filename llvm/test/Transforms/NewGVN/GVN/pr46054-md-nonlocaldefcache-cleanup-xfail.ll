...
; CHECK-NEXT:    store i64 1, ptr [[LUC]], align 8, !invariant.group [[META0:![0-9]+]]
; CHECK-NEXT:    call void @fn(i64 1)
; CHECK-NEXT:    br i1 true, label %[[A:.*]], label %[[ENTRY_B_CRIT_EDGE:.*]]
; CHECK:       [[ENTRY_B_CRIT_EDGE]]:
...
; CHECK-LABEL: define void @test_double_ptr(
; CHECK-SAME: ptr [[DATA:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[LUC:%.*]] = tail call noalias nonnull ptr @data.ptr()
; CHECK-NEXT:    store ptr null, ptr [[LUC]], align 8, !invariant.group [[META0]]
