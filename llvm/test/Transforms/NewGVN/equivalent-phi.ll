...
; CHECK:       bb3:
; CHECK-NEXT:    [[TMP:%.*]] = phi i32 [ [[ARG:%.*]], [[BB:%.*]] ], [ [[TMP15:%.*]], [[BB3_BB3_CRIT_EDGE:%.*]] ]
; CHECK-NEXT:    [[TMP4:%.*]] = phi i32 [ [[ARG2:%.*]], [[BB]] ], [ [[TMP18:%.*]], [[BB3_BB3_CRIT_EDGE]] ]
; CHECK-NEXT:    [[TMP6:%.*]] = phi i32 [ 0, [[BB]] ], [ [[TMP14:%.*]], [[BB3_BB3_CRIT_EDGE]] ]
...
; CHECK-NEXT:    br i1 [[TMP19]], label [[BB3_BB3_CRIT_EDGE]], label [[BB20:%.*]]
