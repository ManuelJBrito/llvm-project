...
; CHECK-JT:       if.then:
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_TRUNC8:%.*]] = phi i32 [ [[CALL2_I]], [[IF_THEN_I]] ], [ [[RC_SROA_43_0_EXTRACT_TRUNC]], [[IF_ELSE_I]] ]
; CHECK-JT-NEXT:    [[CALL1:%.*]] = call signext i32 @dummy(i32 signext 0)
; CHECK-JT-NEXT:    br label [[IF_END]]
; CHECK-JT:       if.end:
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_TRUNC9:%.*]] = phi i32 [ [[RC_SROA_43_0_EXTRACT_TRUNC8]], [[_ZL6CALLEEI_EXIT]] ], [ [[RC_SROA_43_0_EXTRACT_TRUNC]], [[IF_ELSE_I]] ]
; CHECK-JT-NEXT:    ret i32 [[RC_SROA_43_0_EXTRACT_TRUNC9]]
;
