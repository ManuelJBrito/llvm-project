...
; CHECK-JT-NEXT:    [[TMP1:%.*]] = and i64 [[RETVAL_SROA_0_0_INSERT_INSERT_I11_I]], 1
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_SHIFT:%.*]] = lshr i64 [[RETVAL_SROA_0_0_INSERT_INSERT_I11_I]], 32
...
; CHECK-JT-NEXT:    br i1 [[TOBOOL]], label [[IF_END:%.*]], label [[_ZL6CALLEEI_EXIT]]
; CHECK-JT:       if.then:
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_TRUNC6:%.*]] = phi i32 [ [[CALL2_I]], [[IF_THEN_I]] ], [ [[RC_SROA_43_0_EXTRACT_TRUNC]], [[IF_ELSE_I]] ]
; CHECK-JT-NEXT:    [[CALL1:%.*]] = call signext i32 @dummy(i32 signext 0)
; CHECK-JT-NEXT:    br label [[IF_END]]
; CHECK-JT:       if.end:
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_TRUNC7:%.*]] = phi i32 [ [[RC_SROA_43_0_EXTRACT_TRUNC6]], [[_ZL6CALLEEI_EXIT]] ], [ [[RC_SROA_43_0_EXTRACT_TRUNC]], [[IF_ELSE_I]] ]
; CHECK-JT-NEXT:    ret i32 [[RC_SROA_43_0_EXTRACT_TRUNC7]]
;
...
; CHECK-JT-NEXT:    [[TMP1:%.*]] = and i64 [[RETVAL_SROA_0_0_INSERT_INSERT_I10_I]], 4294967296
; CHECK-JT-NEXT:    [[RC_SROA_0_0_EXTRACT_TRUNC1:%.*]] = trunc i64 [[RETVAL_SROA_0_0_INSERT_INSERT_I10_I]] to i32
; CHECK-JT-NEXT:    [[TOBOOL:%.*]] = icmp eq i64 [[TMP1]], 0
; CHECK-JT-NEXT:    br i1 [[TOBOOL]], label [[IF_END:%.*]], label [[_ZL6CALLEEI_EXIT]]
; CHECK-JT:       if.then:
; CHECK-JT-NEXT:    [[RC_SROA_0_0_EXTRACT_TRUNC5:%.*]] = phi i32 [ [[RC_SROA_0_0_EXTRACT_TRUNC3]], [[IF_THEN_I]] ], [ [[RC_SROA_0_0_EXTRACT_TRUNC1]], [[IF_ELSE_I]] ]
; CHECK-JT-NEXT:    [[CALL1:%.*]] = call signext i32 @dummy(i32 signext 0)
; CHECK-JT-NEXT:    br label [[IF_END]]
; CHECK-JT:       if.end:
; CHECK-JT-NEXT:    [[RC_SROA_0_0_EXTRACT_TRUNC:%.*]] = phi i32 [ [[RC_SROA_0_0_EXTRACT_TRUNC5]], [[_ZL6CALLEEI_EXIT]] ], [ [[RC_SROA_0_0_EXTRACT_TRUNC1]], [[IF_ELSE_I]] ]
