...
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i64 [ 1, [[IF_THEN_I]] ], [ [[DOTPRE]], [[IF_ELSE_I]] ]
...
; CHECK-JT-NEXT:    [[DOTPRE:%.*]] = and i64 [[RETVAL_SROA_0_0_INSERT_INSERT_I11_I]], 1
...
; CHECK-JT-NEXT:    [[TOBOOL:%.*]] = icmp eq i64 [[DOTPRE]], 0
; CHECK-JT-NEXT:    br i1 [[TOBOOL]], label [[IF_END:%.*]], label [[IF_THEN]]
; CHECK-JT:       if.then:
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_TRUNC6:%.*]] = phi i32 [ [[CALL2_I]], [[_ZL6CALLEEI_EXIT_THREAD]] ], [ [[RC_SROA_43_0_EXTRACT_TRUNC]], [[_ZL6CALLEEI_EXIT]] ]
; CHECK-JT-NEXT:    [[CALL1:%.*]] = call signext i32 @dummy(i32 signext 0)
; CHECK-JT-NEXT:    br label [[IF_END]]
; CHECK-JT:       if.end:
; CHECK-JT-NEXT:    [[RC_SROA_43_0_EXTRACT_TRUNC7:%.*]] = phi i32 [ [[RC_SROA_43_0_EXTRACT_TRUNC6]], [[IF_THEN]] ], [ [[RC_SROA_43_0_EXTRACT_TRUNC]], [[_ZL6CALLEEI_EXIT]] ]
...
; CHECK-NEXT:    br label [[_ZL6CALLEEI_EXIT]]
; CHECK:       _ZL6calleei.exit:
; CHECK-NEXT:    [[PHIOFOPS:%.*]] = phi i64 [ 4294967296, [[IF_THEN_I]] ], [ [[DOTPRE]], [[IF_ELSE_I]] ]
...
; CHECK-JT-NEXT:    [[DOTPRE:%.*]] = and i64 [[RETVAL_SROA_0_0_INSERT_INSERT_I10_I]], 4294967296
