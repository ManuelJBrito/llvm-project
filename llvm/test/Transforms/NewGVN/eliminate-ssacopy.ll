...
; CHECK:       for.cond1thread-pre-split.if.end11_crit_edge:
...
; CHECK:       for.cond6.preheader.if.end11.loopexit_crit_edge:
; CHECK-NEXT:    br label [[IF_END11_LOOPEXIT1:%.*]]
; CHECK:       for.cond6.preheader3:
; CHECK-NEXT:    br label [[IF_END11_LOOPEXIT1]]
; CHECK:       if.end11.loopexit:
; CHECK-NEXT:    [[STOREMERGE_LCSSA:%.*]] = phi i32 [ 0, [[IF_END11_LOOPEXIT]] ], [ 1, [[FOR_COND6_PREHEADER3]] ]
; CHECK-NEXT:    store i32 [[STOREMERGE_LCSSA]], ptr @b, align 4
; CHECK-NEXT:    br label [[IF_END12]]
; CHECK:       if.end11:
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[DOTPRE]], [[IF_END11]] ], [ [[STOREMERGE_LCSSA]], [[IF_END11_LOOPEXIT1]] ]
