...
; CHECK-NEXT:    [[ARRAYIDX42_PHI_TRANS_INSERT:%.*]] = getelementptr inbounds [3 x [2 x [1 x i8]]], ptr [[ARRAY:%.*]], i64 109, i64 0, i64 0, i64 undef
; CHECK-NEXT:    [[LD2_PRE:%.*]] = load i8, ptr [[ARRAYIDX42_PHI_TRANS_INSERT]], align 1
...
; CHECK-NEXT:    br label [[COND_FALSE1]]
; CHECK:       cond.false:
; CHECK-NEXT:    [[LD2:%.*]] = phi i8 [ [[LD1]], [[COND_TRUE]] ], [ [[LD2_PRE]], [[COND_FALSE]] ]
...
; CHECK:       exit:
; CHECK-NEXT:    [[PHI2:%.*]] = phi i32 [ [[SEXT]], [[COND_END]] ], [ 0, [[COND_FALSE1]] ]
